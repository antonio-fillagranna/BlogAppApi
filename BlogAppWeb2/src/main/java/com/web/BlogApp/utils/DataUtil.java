...
public class DataUtil {
    ...
    public void savePosts(){
        ...
        List<PostModel> postList3 = new ArrayList<>();
        PostModel post3 = new PostModel();
        post3.setAutor("Bruno Alexandre");
        ...
        List<PostModel> postList4 = new ArrayList<>();
        PostModel post4 = new PostModel();
        post4.setAutor("Bruno Alexandre");
